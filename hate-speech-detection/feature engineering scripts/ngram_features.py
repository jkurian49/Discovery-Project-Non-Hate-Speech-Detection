...
data = pd.read_csv('../new datasets/cleaned_tweets-combined.csv',encoding='utf-8')
...
bigrams.to_csv('../new feature datasets/word_bigram_features-combined.csv')
...
char_bigrams.to_csv('../new feature datasets/char_bigram_features-combined.csv')
...
tf_idf.to_csv('../new feature datasets/tfidf_features-combined.csv')
